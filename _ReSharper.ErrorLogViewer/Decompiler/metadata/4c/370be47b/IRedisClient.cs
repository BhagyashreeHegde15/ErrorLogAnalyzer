// Type: ServiceStack.Redis.IRedisClient
// Assembly: ServiceStack.Interfaces, Version=4.0.0.0, Culture=neutral, PublicKeyToken=e06fbc6124f57c43
// Assembly location: C:\ErrorLogViewer\ErrorLogViewer\bin\ServiceStack.Interfaces.dll
...
{
  public interface IRedisClient : IEntityStore, ICacheClient, IDisposable
  {
    void Save();
    void SaveAsync();
    void Shutdown();
